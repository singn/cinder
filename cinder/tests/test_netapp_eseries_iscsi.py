...
from cinder.volume.drivers.netapp.eseries.iscsi import Driver
from cinder.volume.drivers.netapp.eseries.iscsi import netapp_eseries_opts
...
class NetAppEseriesIscsiDriverTestCase(test.TestCase):
    ...
    def _custom_setup(self):
        ...
        self.driver = Driver(configuration=configuration)
    ...
    def test_embedded_mode(self):
        ...
        driver = Driver(configuration=configuration)
