...
netapp_eseries_opts = [
    cfg.StrOpt('netapp_login',
               default=None,
               help='User name for the proxy server.'),
    ...
    cfg.StrOpt('netapp_server_hostname',
               default=None,
               help='Host name for the proxy server.'),
...
class Driver(driver.ISCSIDriver):
    ...
    def _create_snapshot_volume(self, snapshot_id):
        ...
        capacity = int(image['pitCapacity']) / self.UNITS_GB
    ...
    def create_snapshot(self, snapshot):
        ...
        vol_size_gb = int(vol['totalSizeInBytes']) / self.UNITS_GB
    ...
    def _get_or_create_host(self, port_id, host_type='linux'):
        ...
        try:
            ...
            LOG.warn(_("Message - %s."), e.message)
    ...
    def _update_capacity(self):
        ...
        self._stats['free_capacity_gb'] =\
            (tot_bytes - used_bytes) / self.UNITS_GB
        self._stats['total_capacity_gb'] = tot_bytes / self.UNITS_GB
